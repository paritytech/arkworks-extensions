...
use crate::util::{
    fq::serialize_fq::Fq, read_g1_compressed, read_g1_uncompressed, EncodingFlags,
    G1_SERIALIZED_SIZE,
};
...
impl<H: HostFunctions> SWCurveConfig for Config<H> {
    /// COEFF_A = 0
    const COEFF_A: fq::fq::Fq = fq::Fq::ZERO;

    /// COEFF_B = 4
    const COEFF_B: fq::fq::Fq = MontFp!("4");
...
pub const G1_GENERATOR_X: fq::fq::Fq = MontFp!("3685416753713387016781088315183077757961620795782546409894578378688607592378376318836054947676345821548104185464507");

/// G1_GENERATOR_Y =
/// 1339506544944476473020471379941921221584933875938349620426543736416511423956333506472724655353366534992391756441569
pub const G1_GENERATOR_Y: fq::fq::Fq = MontFp!("1339506544944476473020471379941921221584933875938349620426543736416511423956333506472724655353366534992391756441569");

/// BETA is a non-trivial cubic root of unity in fq::Fq.
pub const BETA: fq::fq::Fq = MontFp!("793479390729215512621379701633421447060886740281060493010456487427281649075476305620758731620350");
