...
pub type G1Affine<H> = Affine<Config<H>>;
pub type G1Projective<H> = Projective<Config<H>>;
...
impl<H: HostFunctions> SWCurveConfig for Config<H> {
    ...
    fn mul_affine(base: &Affine<Self>, scalar: &[u64]) -> Projective<Self> {
        ...
        let serialized_result = H::bw6_761_mul_affine_g1(serialized_base, serialized_scalar);
