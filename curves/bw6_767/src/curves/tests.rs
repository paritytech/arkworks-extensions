...
use ark_bw6_767::{g1::Config as ArkG1Config, g2::Config as ArkG2Config, BW6_767 as ArkBW6_767};
use ark_models_ext::{
...
type BW6_767 = crate::BW6_767<TestHooks>;
...
impl CurveHooks for TestHooks {
    fn multi_miller_loop(
        g1: impl Iterator<Item = <BW6_767 as Pairing>::G1Prepared>,
        g2: impl Iterator<Item = <BW6_767 as Pairing>::G2Prepared>,
    ) -> <BW6_767 as Pairing>::TargetField {
        test_utils::multi_miller_loop_generic::<BW6_767, ArkBW6_767>(g1, g2)
    }

    fn final_exponentiation(
        target: <BW6_767 as Pairing>::TargetField,
    ) -> <BW6_767 as Pairing>::TargetField {
        test_utils::final_exponentiation_generic::<BW6_767, ArkBW6_767>(target)
    }
...
test_group!(pairing_output; PairingOutput<BW6_767>; msm);
test_pairing!(pairing; crate::BW6_767<super::TestHooks>);
